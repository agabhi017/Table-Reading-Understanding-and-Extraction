...
#lines_bwimg =cv2.adaptiveThreshold(lines_img,255, cv2.ADAPTIVE_THRESH_GAUSSIAN_C,cv2.THRESH_BINARY,225,-2)
    ...
    for k in range (0,area_outer_bound.shape[0]):
        ...
        #detected_tables = cv2.copyMakeBorder(detected_tables, top, bottom, left, right, cv2.BORDER_CONSTANT, value=color1) #1
            ...
            pocessing_files_2_direc = r"C:\SYND iNNOVATE AI Challenge @ Akash_Abhishek\PROCESSED FILES 2\{}\Detected Tables\{}\{}".format(folder+1,image_no , temp)        
            ...
            filename_tables_1 = r"C:\SYND iNNOVATE AI Challenge @ Akash_Abhishek\PROCESSED FILES 2\{}\Detected Tables\{}\{}\image.jpg".format(folder+1 , image_no , temp)
            filename_tables_vertical = r"C:\SYND iNNOVATE AI Challenge @ Akash_Abhishek\PROCESSED FILES 2\{}\Detected Tables\{}\{}\vertical.jpg".format(folder+1 , image_no , temp)
            filename_tables_horizontal = r"C:\SYND iNNOVATE AI Challenge @ Akash_Abhishek\PROCESSED FILES 2\{}\Detected Tables\{}\{}\horizontal.jpg".format(folder+1 , image_no , temp)
        ...
        processing_files_2_direc = r"C:\SYND iNNOVATE AI Challenge @ Akash_Abhishek\PROCESSED FILES 2\{}\{}".format(folder+1,image_no)        
        ...
        filename_part_image = r"C:\SYND iNNOVATE AI Challenge @ Akash_Abhishek\PROCESSED FILES 2\{}\{}\image.jpg".format(folder+1 , image_no)
        filename_part_image_horizontal = r"C:\SYND iNNOVATE AI Challenge @ Akash_Abhishek\PROCESSED FILES 2\{}\{}\horizontal.jpg".format(folder+1 , image_no)
        filename_part_image_vertical = r"C:\SYND iNNOVATE AI Challenge @ Akash_Abhishek\PROCESSED FILES 2\{}\{}\vertical.jpg".format(folder+1 , image_no)
...
processed_2_direc = "C:\SYND iNNOVATE AI Challenge @ Akash_Abhishek\PROCESSED FILES 2"
total_input_files = len(os.listdir(processed_2_direc))



for j in range (0,total_input_files):
    images = [cv2.imread(file) for file in glob.glob("C:\SYND iNNOVATE AI Challenge @ Akash_Abhishek\PROCESSED FILES 1\{}\*.jpg" .format(j+1)) ]
