1. Unzip the Files in C Drive. (So your path directory for all the files would look like this: "C:\SYND iNNOVATE AI Challenge @ Akash_Abhishek\'Phython codes+ FOLDERS + Tesseract OCR exe file'"
2. Python Files in the 'SYND iNNOVATE AI Challenge @ Akash_Abhishek' folder includes: (MAIN.py , Combined.py, DOC_2_PDF.py, PDF_2_JPG.py)
3. Sub-folders in the 'SYND iNNOVATE AI Challenge @ Akash_Abhishek' folder includes: (INPUT FILES, PROCESSED FILES 1, PROCESSED FILES 2, OUTPUT FILES, poppler-0.68.0)
